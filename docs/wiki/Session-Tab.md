...
The app rebuilds this view as the iRacing SDK changes. In 6.1.0 the tab is intended to follow session transitions correctly instead of staying stuck on the previous session state.
